...
* Function list: mainReader(argc, argv)
*************************************************************/
...
void startReader(string, string, int8, int, int);
...
************************************************************
*/
void startReader(string program, string input, int8 mode, int size, int increment) {

	BufferPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	int loadSize = 0;		/* the size of the file loaded in the buffer */
	int8 symbol;			/* symbol read from input file */
